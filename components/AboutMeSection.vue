	...
	<div class="flex gap-3">
		...
		<div class="flex flex-col justify-start gap-3">
			...
			<p class="text-lg leading-8 text-gray-600 max-w-screen-3xl">
				I'm a full-stack web developer currently based in North America. I work
				with various frontend technologies and frameworks. All the skills and
				tools I use were self-taught and I'm always learning new things. Coding
				is not just a profession for me, it's also a source of fun and
